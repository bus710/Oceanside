...
Up to 295 commands can be sent per 1 second however, it is better to avoid full throughput but 80% might be good. (295 * 0.8 = 236 commands/second)
...
The first byte is major command so that it cartegorizes the next byte as minor command.
...
| :------: | :------: | ------ | :------: | :------: | ------ |
| 1 | 0 | System Information | 0x00 | R | MCU Name | 
| 2 | 0 | "                 | 0x80 | W (N/A) | MCU Name |
| 3 | 0 | System Information | 0x01 | R | HW Name | 
| 4 | 0 | "                 | 0x81 | W (N/A) | HW Name |
...
Since MCU name is a minor command and included under major command of System Information, the commands are 0x00 and 0x00 respectively.  
...
MSB of minor command doesn't matter but other field should be kept to show what the original request was for returned payload.  
